      ...
      <HomeNavbar/>
         <View style={styles.centeredView} >
          ...
          <View style={styles.contentContainer}>
              <View>
                    <Image
                        source={require('../assets/businessfinanceform.png')}
                        style={{ marginTop:'90px', marginLeft:'25px', marginRight:'20px'}}
                      />
              </View>
...
const styles = StyleSheet.create({
    ...
    contentContainer: {
      ...
      picker:{
        height:40, width: '100%', border:'none', fontSize:'16px',fontWeight: 500, marginTop:'-10px', flexDirection:'column', justifyContent:'center', alignItems:'center'
      },
      checkboxContainer: {
        flexDirection: 'row',
        margin: 'auto',

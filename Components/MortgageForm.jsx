  ...
  return (
    <View style={styles.container} >
      ...
      <View style={styles.contentContainer}>
              <View>
                  <Image
                      source={require('../assets/mortgageform.png')}
                      style={{ marginTop:'120px', marginLeft:'40px', marginRight:'20px'}}
                      />
              </View>
                ...
                <form>
                    ...
                    <View style={styles.input}>
                            <Picker
                                ...
                                <Picker.Item label="Type of Property" value="" />
                    ...
                    <View style={styles.input}>
                            <Picker
                                ...
                                style={ styles.picker}
                                onValueChange={(itemValue) => setSelectedOption(itemValue)}>
                                <Picker.Item label="Property Location" value="" />
                                <Picker.Item label="Option 1" value="option1" />
                                <Picker.Item label="Option 2" value="option2" />
                                <Picker.Item label="Option 3" value="option3" />
                            </Picker>
                    ...
                    <View style={styles.input}>
                            <Picker
                                ...
                                style={ styles.picker}
                                onValueChange={(itemValue) => setSelectedOption(itemValue)}>
                                <Picker.Item label="Monthly Income" value="" />
                                <Picker.Item label="Option 1" value="option1" />
                                <Picker.Item label="Option 2" value="option2" />
                                <Picker.Item label="Option 3" value="option3" />
                            </Picker>

    ...
    <View style={styles.container} >
      <View style={styles.centeredView}  >
        ...
        <View style={{ marginTop:'30px' }} >
            <Image source={require('../../assets/passwordreset.png')} />
            <View style={{ width:'100%', maxWidth:'300px'}} >
            <Text style={{marginTop:'10px', color:'#A4A4A4'}} >Your password has been successfully reset. click confirm to set a new password.</Text>
            </View>
        </View>
